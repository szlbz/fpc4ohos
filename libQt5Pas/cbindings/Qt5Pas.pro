...
# OHOS and other non-X11 platforms don't have X11
!qtHaveModule(x11extras): {
  message("X11 not available, removing X11 sources.")
  HEADERS -= qx11info_x11_c.h
  SOURCES -= qx11info_x11_c.cpp

# 若编译 QT 时配置了 openssl ，可屏蔽掉以下代码
  HEADERS -= qsslcipher_c.h \
             qsslkey_c.h \
             qsslerror_c.h \
             qsslconfiguration_c.h \
             qnetworkreply_c.h \
