...
{$ENDIF}
  ...
  TOS=(osNone,
    ...
    wasip1,human68k,ps1,wasip1threads,wasip2,ohos
  );
  TOSes = Set of TOS;
...
Const
  ...
  AllUnixOSes  = [Linux,FreeBSD,NetBSD,OpenBSD,Darwin,QNX,BeOS,Solaris,Haiku,iphonesim,ios,aix,Android,dragonfly,ohos];
