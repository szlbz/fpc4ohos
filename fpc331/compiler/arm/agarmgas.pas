...
{$endif extdebug}
    ...
    const
       as_arm_gas_info : tasminfo =
          (
            ...
            supported_targets : [system_arm_linux,system_arm_netbsd,system_arm_wince,system_arm_gba,system_arm_palmos,system_arm_nds,
                                 system_arm_embedded,system_arm_symbian,system_arm_android,system_arm_aros,system_arm_freertos,system_arm_harmonyos];
       ...
       as_arm_clang_darwin_info : tasminfo =
        ...
        as_arm_clang_gas_harmonyos_info : tasminfo =
           (
             id     : as_clang_gas;
             idtxt  : 'AS-CLANG';
             asmbin : 'clang';
             asmcmd : '-x assembler -c -target $TRIPLET -o $OBJ $EXTRAOPT -x assembler $ASM';
             supported_targets : [system_arm_harmonyos];
             flags : [af_needar,af_smartlink_sections,af_supports_dwarf,af_llvm,af_supports_hlcfi];
             labelprefix : '.L';
             labelmaxlen : -1;
             comment : '# ';
...
begin
  ...
  RegisterAssembler(as_arm_clang_gas_harmonyos_info,TARMGNUAssembler);
end.
